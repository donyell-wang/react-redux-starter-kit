...
forked from [react-redux-starter-kit](https://github.com/davezuko/react-redux-starter-kit)

the ONLY difference is that Redux-thunk is replaced by Redux-observable
